				    ...
				    <div class="container">
				          ...
				          <div class="pages_tabs1">
				              ...
				              <ul class="nav tab_style2" role="tablist">
				              	<li class="nav-item">
				                  <a class="nav-link active" data-toggle="tab" href="#tab0">Program Educational Objectives <span class="dropdown-toggle"></span></a>
				              	</li>
				              	<li class="nav-item">
				                  <a class="nav-link" data-toggle="tab" href="#tab1">Program Outcomes<span class="dropdown-toggle"></span></a>
				              	</li>
				              </ul>
				          </div>
					          	...
					          	<div class="">
						              <div class="tab-content r_last_li" id="tab_parent">
						                <div id="tab0" class="tab-pane active">
						                	...
						                	<div class="row">
										      	<div class="col-md-12">
										      		<p><b>The graduates of the B.Pharm Program will</b></p>
										      		<ul class="ul_style mb-0">
										      			<li>Practice as successful professionals in manufacturing, quality control, marketing and dispensing of pharmaceuticals.</li>
														<li>Analyze the problems involved in various pharmaceuticals manufacturing processes using modern pharmaceutical tools.</li>
														<li>Adapt to rapid changes in the field of pharmaceutical sciences through continuous education, professional development and self-study.</li>
														<li>Communicate effectively among health care professionals and to assume leadership roles appropriate to facilitate improvement in health and well-being of society.</li>
														<li>Apply ethical principles in profession of pharmacy for health of society, environmental safety and sustainable development.</li>
										      		</ul>
										      	</div>
										      </div>
						                </div>
						                <div id="tab1" class="tab-pane">
					                		...
					                		<div class="row">
										      	<div class="col-md-12">
										      		<ul class="ul_style mb-0">
										      			<li><b>Pharmacy Knowledge:</b> Possess knowledge and comprehension of the core and basic knowledge associated with the profession of pharmacy, including biomedical sciences; pharmaceutical sciences; behavioral, social, and administrative pharmacy sciences; and manufacturing practices.</li>
										      			<li><b>Planning Abilities:</b> Demonstrate effective planning abilities including time management, resource management, delegation skills and organizational skills. Develop and implement plans and organize work to meet deadlines.</li>
														<li><b>Problem analysis:</b> Utilize the principles of scientific enquiry, thinking analytically, clearly and critically, while solving problems and making decisions during daily practice. Find, analyze, evaluate and apply information systematically and shall make defensible decisions.</li>
														<li><b>Modern tool usage:</b> Learn, select, and apply appropriate methods and procedures, resources, and modern pharmacy-related computing tools with an understanding of the limitations.</li>
														<li><b>Leadership skills:</b> Understand and consider the human reaction to change, motivation issues, leadership and team-building when planning changes required for fulfillment of practice, professional and societal responsibilities. Assume participatory roles as responsible citizens or leadership roles when appropriate to facilitate improvement in health and wellbeing.</li>
														<li><b>Professional Identity:</b> Understand, analyze and communicate the value of their professional roles in society (e.g. health care professionals, promoters of health, educators, managers, employers, employees).</li>
														<li><b>Pharmaceutical Ethics:</b> Honour personal values and apply ethical principles in professional and social contexts. Demonstrate behavior that recognizes cultural and personal variability in values, communication and lifestyles. Use ethical frameworks; apply ethical principles while making decisions and take responsibility for the outcomes associated with the decisions.</li>
														<li><b>Communication:</b> Communicate effectively with the pharmacy community and with society at large, such as, being able to comprehend and write effective reports, make effective presentations and documentation, and give and receive clear instructions.
														The Pharmacist and society: Apply reasoning informed by the contextual knowledge to assess societal, health, safety and legal issues and the consequent responsibilities relevant to the professional pharmacy practice.</li>
														<li><b>Environment and sustainability:</b> Understand the impact of the professional pharmacy solutions in societal and environmental contexts, and demonstrate the knowledge of, and need for sustainable development.</li>
														<li><b>Life-long learning:</b> Recognize the need for, and have the preparation and ability to engage in independent and life-long learning in the broadest context of technological change. Self assess and use feedback effectively from others to identify learning needs and to satisfy these needs on an ongoing basis.</li>
